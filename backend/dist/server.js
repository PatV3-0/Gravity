...
var CommentSchema = new mongoose.Schema({
  ...
  // Reference to the PlayList model
  text: String,
  date: {
    type: Date,
    "default": Date.now
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          id = req.params.id;
          _context2.next = 4;
          return PlayList.findById(id).populate('songs').populate('comments');
        case 4:
...
app.post('/api/signup', /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var _req$body2, fullName, email, password, username, surname, profileImage, existingUser, newUser;
...
app.put('/api/users/:userId', /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    var userId, _req$body3, username, profileImage, password, oldPassword, user, updatedUser;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          console.log(req.params);
          userId = req.params.userId;
          _req$body3 = req.body, username = _req$body3.username, profileImage = _req$body3.profileImage, password = _req$body3.password, oldPassword = _req$body3.oldPassword;
          _context8.prev = 3;
          _context8.next = 6;
          return User.findById(userId);
        case 6:
...
app.post('/api/playlists', /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9(req, res) {
    var _req$body4, userId, playlistName, description, dateCreated, newPlaylist;
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          _req$body4 = req.body, userId = _req$body4.userId, playlistName = _req$body4.playlistName, description = _req$body4.description, dateCreated = _req$body4.dateCreated;
          _context9.prev = 1;
...
app.put('/api/playlists/:id', /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee10(req, res) {
    var id, _req$body5, name, description, updatedPlaylist;
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          ...
          _context10.prev = 2;
          _context10.next = 5;
          return PlayList.findByIdAndUpdate(id, {
            name: name,
            description: description
          }, {
            "new": true
    ...
    return _regeneratorRuntime().wrap(function _callee12$(_context12) {
      while (1) switch (_context12.prev = _context12.next) {
        ...
        case 14:
          ...
          console.error('Error deleting user and playlists:', _context12.t0);
          res.status(500).json({
...
app.post('/api/friend/:userId', /*#__PURE__*/function () {
  var _ref13 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee13(req, res) {
    var userId, currentUserId, user, currentUser;
    return _regeneratorRuntime().wrap(function _callee13$(_context13) {
      while (1) switch (_context13.prev = _context13.next) {
        ...
        case 20:
          ...
          console.error('Error friending user:', _context13.t0);
          res.status(500).json({
    ...
    return _regeneratorRuntime().wrap(function _callee14$(_context14) {
      while (1) switch (_context14.prev = _context14.next) {
        ...
        case 20:
          ...
          console.error('Error unfriending user:', _context14.t0);
          res.status(500).json({
    ...
    return _regeneratorRuntime().wrap(function _callee15$(_context15) {
      while (1) switch (_context15.prev = _context15.next) {
        ...
        case 11:
          ...
          console.error('Error adding song to playlist:', _context15.t0);
          res.status(500).json({
    ...
    return _regeneratorRuntime().wrap(function _callee16$(_context16) {
      while (1) switch (_context16.prev = _context16.next) {
        ...
        case 11:
          ...
          console.error('Error removing song from playlist:', _context16.t0);
          res.status(500).json({
    ...
    return _regeneratorRuntime().wrap(function _callee17$(_context17) {
      while (1) switch (_context17.prev = _context17.next) {
        case 0:
          ...
          _context17.prev = 1;
          _context17.next = 4;
          return PlayList.findById(id).populate({
            path: 'comments',
            // Populate comments
            populate: {
              path: 'user',
              select: 'username'
            } // Within each comment, populate the 'user' field
          });
        case 4:
        ...
        case 10:
          ...
          console.error("Error fetching comments:", _context17.t0);
          res.status(500).json({
...
app.post('/api/playlists/:playlistId/comments', /*#__PURE__*/function () {
  var _ref18 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee18(req, res) {
    var playlistId, _req$body6, userId, text, comment;
    return _regeneratorRuntime().wrap(function _callee18$(_context18) {
      while (1) switch (_context18.prev = _context18.next) {
        ...
        case 11:
          ...
          console.error('Error adding comment:', _context18.t0);
          res.status(500).json({
...
app.get('/comments/:id', /*#__PURE__*/function () {
